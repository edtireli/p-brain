...
def welcome_screen():
    ...
    print('| '+colored('4', 'cyan')+' | Find and save the TSCC with the greatest concentration')
    print('| '+colored('5', 'cyan')+' | Create Tissue (Grey/White matter) CTCs')
    #print('| '+colored('6', 'cyan')+' | Create W/G Matter Boundary CTC')
    print('| '+colored('6', 'cyan')+' | Compute BBB permeability and perfusion parameters')
