...
MAP_JOBS: Sequence[MapJob] = (
    ...
    MapJob("mtt_map", "mtt_montage", vmin=0.0, vmax=15.0, search_directories=("", "tikhonov")),
    MapJob("MTT_tikhonov_map_atlas", "mtt_parcel_montage", vmin=0.0, vmax=15.0, search_directories=("", "tikhonov")),
    MapJob("cth_map", "cth_montage", vmin=0.0, vmax=15.0, search_directories=("", "tikhonov")),
    MapJob("CTH_tikhonov_map_atlas", "cth_parcel_montage", vmin=0.0, vmax=15.0, search_directories=("", "tikhonov")),
